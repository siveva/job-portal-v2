                                                ...
                                                <div class="col-md">
                                                    <div class="form-group">
                                                        <div class="form-field">
                                                            ...
                                                            <input type="text" name="jobTitle" class="form-control" value="@if(isset($jobTitle)) {{ $jobTitle }} @endif" placeholder="eg. Garphic. Web Developer">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md">
                                                        ...
                                                        <div class="form-field">
                                                            <div class="select-wrap">
                                                                ...
                                                                <select name="jobType" id="jobType" class="form-control">
                                                                    <option value="" @if(!isset($jobType)) selected  @endif>Job Type</option>
                                                                    <option value="part-time" @if(isset($jobType) && $jobType === "part-time") selected  @endif >Part Time</option>
                                                                    <option value="full-time" @if(isset($jobType) && $jobType === "full-time") selected  @endif>Full Time</option>
                                                                    <option value="freelance" @if(isset($jobType) && $jobType === "freelance") selected  @endif>Freelance</option>
                                                                    <option value="internship" @if(isset($jobType) && $jobType === "internship") selected  @endif>Internship</option>
                                                                    <option value="temporary" @if(isset($jobType) && $jobType === "temporary") selected  @endif>Temporary</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md">
                                                    <div class="form-group">
                                                        <div class="form-field">
                                                            ...
                                                            <input type="text" name="location" class="form-control" value="@if(isset($location)) {{ $location }} @endif" placeholder="Location">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md">
