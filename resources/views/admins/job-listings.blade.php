                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm deleteBtn" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{ $jobPost->id }}" data-name="{{ $jobPost->title }}"><i class="fas fa-trash"></i> {{ __('Delete') }}</button>
                                </div>
                            </td>
                        </tr>
                    @empty
