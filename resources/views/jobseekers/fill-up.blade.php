...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Fill Up Your Information') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jobseeker.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="resume" type="file" class="form-control-file @error('resume') is-invalid @enderror" name="resume" value="{{ old('resume') }}" required autocomplete="resume">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ route('jobseeker.dashboard') }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
