    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 heading-section text-center ftco-animate">
          <span class="subheading">We have {{ $jobResults->count() }} {{ Str::plural('job', $jobResults->count()) }} for you <br>Click apply job to view details</span>
          <h2 class="mb-4">
            ...
            <div class="col-md-12 ftco-animate">
                <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                    ...
                    <div class="ml-auto d-flex">
                        <small class="d-flex align-items-center mr-1"><i class="far fa-calendar-alt text-primary me-2 mr-1"></i>Date Line: {{ $jobResult->deadline->format('d M, Y') }}</small>
                        {{-- <a href="{{ route('job-single',$job->id) }}" class="btn btn-primary py-2 mr-1">Apply Job</a> --}}
                        <a href="{{ route('job-single', ['id' => $jobResult->id]) }}" class="btn btn-primary py-2 mr-1">Apply Job</a>
