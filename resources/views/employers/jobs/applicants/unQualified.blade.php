...
<h1 class="mt-4">{{ $job->title }} <span style="font-style: italic;color: red;">Unshortlisted</span> Applicants</h1>
...
<div class="card mb-4">
    <div class="card-header">
        ...
        List of Applicants
        <span style="float: right"><a href="{{ route('applications.index', ['id' => $_GET['id']]) }}">View Shortlisted Applicants</a></span>
    </div>
    <div class="card-body">
